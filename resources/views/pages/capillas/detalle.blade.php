        ...
        <div class="container-main">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
                ...
                <div class="lg:col-span-2">
                    ...
                    @if($horarios->count() > 0)
                        <div class="mb-12">
                            <h2 class="font-serif text-2xl font-bold text-gray-900 mb-6">{{ __('general.chapels.mass_schedules') }}</h2>
                    ...
                    @if($grupos->count() > 0)
                        <div>
                            <h2 class="font-serif text-2xl font-bold text-gray-900 mb-6">{{ __('general.chapels.parish_groups') }}</h2>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <aside class="lg:col-span-1">
                    <div class="sticky top-24 space-y-6">
                        ...
                        <div class="card p-6">
                            <h3 class="font-semibold text-lg text-gray-900 mb-4">{{ __('general.chapels.contact_info') }}</h3>
                            <dl class="space-y-4">
                                @if($capilla->direccion)
                                    <div>
                                        <dt class="text-sm text-gray-500 mb-1">{{ __('general.contact.address') }}</dt>
                                ...
                                @if($capilla->telefono)
                                    <div>
                                        <dt class="text-sm text-gray-500 mb-1">{{ __('general.contact.phone') }}</dt>
                                ...
                                @if($capilla->email)
                                    <div>
                                        <dt class="text-sm text-gray-500 mb-1">{{ __('general.contact.email') }}</dt>
                                        <dd class="flex items-center gap-2 text-gray-900">
                                            <svg class="w-5 h-5 text-primary-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="{{ route('capillas.index', ['locale' => app()->getLocale()]) }}"
                           class="inline-flex items-center gap-2 text-primary-600 hover:text-primary-700 font-medium">
                            ...
                            {{ __('general.actions.view_all') }} {{ strtolower(__('general.nav.chapels')) }}
                        </a>
                    </div>
                </aside>
            </div>
        ...
        <section class="py-16 bg-gray-50">
            <div class="container-main">
                <h2 class="font-serif text-2xl lg:text-3xl font-bold text-gray-900 mb-8">
                    {{ __('general.chapels.other_chapels') }}
                </h2>
